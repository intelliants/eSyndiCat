...
class esynImporter extends esynAdmin
{
	...
	function parseXml()
	{
		...
		if(!file_exists(ESYN_INCLUDES.'imports'.ESYN_DS.'2.2.06_2.3'.ESYN_DS.'import.xml'))
		{
			return false;
		}

		$this->mQueries = xml2array(file_get_contents(ESYN_INCLUDES.'imports'.ESYN_DS.'2.2.06_2.3'.ESYN_DS.'import.xml', false));
